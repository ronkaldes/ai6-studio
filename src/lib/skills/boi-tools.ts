// BOI Innovation Tool system prompts.
// Each is a plain string (like OPPORTUNITY_MEMO_PROMPT, not the function pattern of AGENT_PROMPTS).
// Context injection happens via buildSystemPrompt() at the API route level.

export const BOI_TOOL_PROMPTS = {
  futureScenarios: `You are a strategic foresight analyst for a startup studio.
...
Return ONLY valid JSON matching this exact schema:
{
  ...
  personas: `You are a user research expert for a startup studio.
...
[
  ...
  hmw: `You are a design thinking facilitator for a startup studio.
...
[
  ...
  businessReinvention: `You are an AI transformation strategist for a startup studio.
...
Return ONLY valid JSON matching this exact schema:
{
  ...
  strategyMatrix: `You are an AI strategy consultant for a startup studio.
...
Return ONLY valid JSON matching this exact schema:
{
  ...
  blueprint: `You are an AI transformation architect for a startup studio.
...
Return ONLY valid JSON matching this exact schema:
{
  ...
  simulation: `You are an AI transformation simulator for a startup studio.
